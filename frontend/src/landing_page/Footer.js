...
export default function Footer() {
  return (
    <div className="container-fluid border-top bg-body-tertiary p-4">
      <div className="row">
        <div className="col">
          <img src="media/images/logo.svg" style={{ width: "45%" }}></img>
          <p>
            <i className="fa-regular fa-copyright"></i> 2010-2-24, Not Zerodha
            Broking Ltd.
            <br />
            All rights reserved
          </p>
        ...
        <div className="col">
          <h5 className="fw-normal">Support</h5>
          <a href="#">About</a>
          <br />
          <a href="#">Products</a>
          <br />
        ...
        <div className="col">
          <h5 className="fw-normal">Account</h5>
          <a href="#">About</a>
          <br />
          <a href="#">Products</a>
          <br />
